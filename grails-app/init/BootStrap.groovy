...
class BootStrap {
    ...
    def initUsers() {
        ...
        Role userRole = new Role('ROLE_USER').save(flush: true)

        User adminUser = new User('mick', 'password').save(flush: true)
        User standardUser = new User('billybob', 'password').save(flush: true)
